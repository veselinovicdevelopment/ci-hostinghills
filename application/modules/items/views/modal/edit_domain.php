				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<select class="form-control" name="default_registrar">
							...
							<option value="resellerclub" <?=($item->default_registrar == 'resellerclub') ? 'selected' : ''?>>ResellerClub</option>
							<option value="namecheap" <?=($item->default_registrar == 'namecheap') ? 'selected' : ''?>>Namecheap</option>
							<option value="domainscoza" <?=($item->default_registrar == 'domainscoza') ? 'selected' : ''?>>DomainsCoZa</option>
						</select>
					</div>
				</div>			
