		...
		<input type="hidden" name="quantity" value="1">
			<div class="form-group">
				...
				<select id="server" name="server" class="form-control m-b">
					...
					<option value="<?=$server->id?>"><?=$server->name?> - <span class="label label-default"><small><?=$server->type?></small></span></option>
					<?php } ?>
				</select>
				</div>
				</div>		
				...
				<div class="col-lg-8">
					...
					<div class="col-lg-8">
						<input type="text" class="form-control" placeholder="<?=lang('package_name')?>" name="package_name">
					</div>
					</div>
					...
					<div class="col-lg-8">
					<textarea class="form-control ta" name="item_features" placeholder="<?=lang('features_example')?>"></textarea>
					</div>
					</div>
