<div class="box">
	...
	<div class="container">
		...
		<section class="panel panel-default bg-white m-t-lg radius_3">
					...
					<?php $url = (config_item('demo_mode')  == 'TRUE') ? 'sandbox.payfast.co.za' : 'www.payfast.co.za';?>
					<form action="https://<?php echo $url;?>/eng/process" class="content-center" method="post" id="pf_form" name="pf_form">
						...
						$data  = array(
							'merchant_id' => config_item('payfast_merchant_id'),
							'merchant_key' => config_item('payfast_merchant_key'),
						...
						$passPhrase = config_item('payfast_passphrase');
