        ...
        <div class="col-sm-6"> 
            ...
            <div class="col-md-6 inner-order">
                ...
                <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="submit" class="btn btn-info btn-block" id="Transfer" value="<?= lang('transfer') ?>" /> 
                        </div>
                        <div class="col-md-3">
                            <input type="submit" class="btn btn-primary btn-block" id="Search" value="<?= lang('register') ?>" />		
                        </div>
                </div>
                <p>
                <div class="checking">
