        ...
        if ($_POST) {
            ...
            switch ($this->input->post('delete_cat')) {
                case 'on':
                    ...
                    $this->db->where('param', "items_".$id)->where('module', 'Items')->delete('blocks_modules');
                    $block = $this->db->where('id', "items_".$id)->where('module', 'Items')->get('blocks')->row();
                    if($block) {
                        $this->db->where('id', "items_".$id)->where('module', 'Items')->delete('blocks');
